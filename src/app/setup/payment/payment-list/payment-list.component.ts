...
export class PaymentListComponent {
  displayedColumns2: string[] = ['id', 'fullName', 'email','rewardPoints', 'phoneNumber'];
  displayedColumns: string[] = ['id', 'fullName', 'email','amount', 'charge','tx_ref','status'];
  ...
  truncateText(text: string): string {
    const maxLength = 10; // Adjust the length as needed
  ...
  async getPayments() {
    try {
      this.payment.getPayments().then(res=>{
